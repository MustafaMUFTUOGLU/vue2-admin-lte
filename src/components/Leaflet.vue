        ...
        <div class="box-body"  :class="{'personel-search-bar-open': visibleSearchBar}">
          <div class="my-map-class deneme" style="height: auto;">
            ...
            >
              ...
              <l-layer-group>
                <l-layer-group layer-type="overlay" :name="$t('Map.Gateway')" :visible="true">
                  <l-marker :icon="gatewayIcon" v-for="basestation in basestationsFiltered" :key="basestation.BaseStationName" :lat-lng="[basestation.Y, basestation.X]">
                    <l-popup :content="basestation.BaseStationName" />
                  </l-marker>
                </l-layer-group>

                
                <l-layer-group layer-type="overlay" :name="$t('Map.Beacon')" :visible="true">
          ...
          <div class="personel-search-bar deneme">
            <div class="sidebar-form">
              <div class="input-group">
                <input type="text" name="q" class="form-control" :placeholder="$t('Person.Name')" @input="addEvent" @change="addEvent">
            ...
            <ul class="contacts-list"> 
              <li v-for="basestation in basestationsFiltered" :key="basestation.BaseStationName">
                <div style="btn" @click="focusMaker(basestation)">
                  ...
                  <div class="contacts-list-info" style="margin-left: 25px;">
                    <span class="contacts-list-name"> {{basestation.BaseStationName}}</span>
