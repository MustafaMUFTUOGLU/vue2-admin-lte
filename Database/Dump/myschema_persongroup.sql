...
LOCK TABLES `persongroup` WRITE;
/*!40000 ALTER TABLE `persongroup` DISABLE KEYS */;
INSERT INTO `persongroup` VALUES (1,'Accounting'),(2,'Human Resources'),(3,'Sales'),(4,'Support'),(5,'Training');
/*!40000 ALTER TABLE `persongroup` ENABLE KEYS */;
UNLOCK TABLES;
